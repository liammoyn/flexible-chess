...
/**
 * Remove a piece from the board. Similar to Kill except this piece was not killed by a specific other piece
 */
case class RemovePiece(executor: Piece) extends Effect {
